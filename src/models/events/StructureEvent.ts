...
export interface StructureEvent {
	...
	sweptDepth: number
	/**
	 * true = незадолго до слома (окно oppositeSweepLookback) сняли ликвидность
	 * с ПРОТИВОПОЛОЖНОГО экстремума: для бычьего слома — прокол недавнего low
	 * фитилём без слома. Классика ICT: разворот после стоп-ханта надёжнее.
	 * Аннотация для A/B-разрезов — на отбор событий не влияет.
	 */
