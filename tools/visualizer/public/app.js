...
function redraw(){if(!data)return;if(refinedMode){renderRefined();return}if(labMode){renderLab();return}clearOverlays();renderList();renderEvents();renderProtected();renderMarkers();renderSelected();renderDetail();renderCards()}
