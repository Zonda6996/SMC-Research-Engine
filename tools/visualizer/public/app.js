...
function confirmationAttempts(){const out=[];for(const r of(data?.poiConfirmation?.results||[]))for(const a of r.attempts)out.push({...a,poiId:r.poiId,direction:r.direction,zoneClass:r.zoneClass,near:r.near,far:r.far});return out}
