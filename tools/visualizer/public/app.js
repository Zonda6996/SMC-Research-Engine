...
const LIFE_RU={forming:'формируется',fresh:'готова','in-play':'в игре',consumed:'использована',failed:'не сработала',retired:'устарела'}
...
function confirmationAttempts(){const out=[];for(const r of(data?.poiConfirmation?.results||[]))for(const a of r.attempts)out.push({...a,poiId:r.poiId,direction:r.direction,zoneClass:r.zoneClass,near:r.near,far:r.far,knownAt:r.knownAt,endAt:r.endAt});return out}
