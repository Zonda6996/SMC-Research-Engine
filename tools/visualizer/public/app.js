...
function redraw(){if(!data)return;if(poiZoneMode){renderPoiZones();return}if(confMode){renderConfirmation();return}if(labMode){renderLab();return}clearOverlays();renderList();renderEvents();renderProtected();renderMarkers();renderSelected();renderHeatmap();renderDetail();renderCards()}
...
$('filtersToggle').onclick=()=>{const v=$('filtersControls').style.display!=='none';$('filtersControls').style.display=v?'none':'';$('filtersToggle').textContent=v?'\u041f\u043e\u043a\u0430\u0437\u0430\u0442\u044c':'\u0421\u043a\u0440\u044b\u0442\u044c'}
$('tradesToggle').onclick=()=>{const v=$('tradesControls').style.display!=='none';$('tradesControls').style.display=v?'none':'';$('tradesToggle').textContent=v?'\u041f\u043e\u043a\u0430\u0437\u0430\u0442\u044c':'\u0421\u043a\u0440\u044b\u0442\u044c'}
