...
> Обновлено: 2026-07-28. Ветка: **`simplified-mode-v1`** (liquidity-improvements-v1 слита в main 27.07, PR #7, merge 45a91f6 — 13 QA-раундов приняты). Актуальный фронт работ — раздел 0.5, читать его ПЕРВЫМ; правила движков — SPEC §16.8–§16.27.
>
