...
Версии движков: `liquidity-poi-1.4-overlap-dedup`, `poi-confirmation-1.6-quiet-reanchor`. Тесты 289/289 (`npx tsx --test tests/*.test.ts`), `tsc --noEmit` чистый, `node --check tools/visualizer/public/app.js` чистый. Правила движков — SPEC §16.8–§16.12 поверх §12–§15; устаревшие куски §13.1/13.2/14.2(объём)/14.4/14.5 помечены заменёнными в этих секциях.

### ГЛАВНОЕ ЗАДАНИЕ №1: Liquidity POI 2.0 — «зоны от ликвидности» (утверждено, SPEC §16.12)
