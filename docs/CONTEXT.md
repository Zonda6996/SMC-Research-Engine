...
## 0.5 Текущий фронт работ (27.07.2026): приёмка фиксов 12-го QA (§16.22) + СПЕКА упрощённого режима по ответам пользователя
...
1. **Приёмка фиксов 12-го QA (§16.22)**: DOGE 1d — шорты 0.0955→0.0994 и 0.1166→0.1259 (его «хотя бы так»); «1h: только ближайшие» (ближайшая сверху/снизу + в игре); слоёные зоны от последнего вклада; data-end = «живая у края». Скрин = ТЗ.
