...
```text
liquidity-poi-1.1-causal-liquidity
```

Текущая версия движка подтверждения:

```text
poi-confirmation-1.3-unified-window
```

Ранний прототип refined-poi-0.2 выведен из визуализатора и не развивается. Правила движков — §16.8 (поверх §13–§15).
