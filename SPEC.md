...
```text
liquidity-poi-1.3-stack-far
```

Текущая версия движка подтверждения:

```text
poi-confirmation-1.5-persistent-sweep
```

Ранний прототип refined-poi-0.2 выведен из визуализатора и не развивается. Правила движков — §16.8–§16.10 (поверх §13–§15).
