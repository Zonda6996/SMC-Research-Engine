...
const inputs: InputSpec[] = [
	{ id: 'eth-2h', file: 'C:/Users/Никита/Downloads/BYBIT_ETHUSDT.P, 120.csv', timeframeMinutes: 120 },
	{ id: 'eth-1h', file: 'C:/Users/Никита/Downloads/BYBIT_ETHUSDT.P, 60.csv', timeframeMinutes: 60 },
	{ id: 'sol-2h', file: 'C:/Users/Никита/Downloads/BYBIT_SOLUSDT.P, 120.csv', timeframeMinutes: 120 },
	{ id: 'sol-1h', file: 'C:/Users/Никита/Downloads/BYBIT_SOLUSDT.P, 60.csv', timeframeMinutes: 60 },
	{ id: 'xrp-2h', file: 'C:/Users/Никита/Downloads/BYBIT_XRPUSDT.P, 120.csv', timeframeMinutes: 120 },
	{ id: 'xrp-1h', file: 'C:/Users/Никита/Downloads/BYBIT_XRPUSDT.P, 60.csv', timeframeMinutes: 60 },
	{ id: 'aave-2h', file: 'C:/Users/Никита/Downloads/BYBIT_AAVEUSDT.P, 120 (1).csv', timeframeMinutes: 120 },
	{ id: 'aave-1h', file: 'C:/Users/Никита/Downloads/BYBIT_AAVEUSDT.P, 60.csv', timeframeMinutes: 60 },
	{ id: 'bnb-2h', file: 'C:/Users/Никита/Downloads/BYBIT_BNBUSDT.P, 120.csv', timeframeMinutes: 120 },
	{ id: 'bnb-1h', file: 'C:/Users/Никита/Downloads/BYBIT_BNBUSDT.P, 60.csv', timeframeMinutes: 60 },
]
...
const eventStudy = datasets.map(({ input, rows }) => {
	...
	return {
		...
		horizons: horizonsHours.map((hours, horizonIndex) => {
			...
			const nullResult = bootstrapNull(rows, sides, bars, 20260804 + horizonIndex * 101 + input.timeframeMinutes)
...
const result = {
	...
	scope: 'frozen multi-asset holdout audit; next-open; no fees, funding or slippage; protocol fixed before viewing ETH/SOL/XRP/AAVE/BNB results; no holdout refit',
	assumptions: {
...
writeFileSync(resolve(outDir, 'ggi-multi-asset-holdout-v1.json'), `${JSON.stringify(result, null, 2)}\n`)
