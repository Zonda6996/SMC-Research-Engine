...
const inputs: InputSpec[] = [
	{ id: 'btc-5m', file: 'C:/Users/Никита/Downloads/BYBIT_BTCUSDT.P, 5.csv', timeframeMinutes: 5 },
	{ id: 'eth-5m', file: 'C:/Users/Никита/Downloads/BYBIT_ETHUSDT.P, 5.csv', timeframeMinutes: 5 },
	{ id: 'sol-5m', file: 'C:/Users/Никита/Downloads/BYBIT_SOLUSDT.P, 5.csv', timeframeMinutes: 5 },
	{ id: 'xrp-5m', file: 'C:/Users/Никита/Downloads/BYBIT_XRPUSDT.P, 5.csv', timeframeMinutes: 5 },
	{ id: 'bnb-5m', file: 'C:/Users/Никита/Downloads/BYBIT_BNBUSDT.P, 5.csv', timeframeMinutes: 5 },
]
...
const datasets = inputs.map((input) => {
	...
	const dashboardWindow = rows.slice(-20_000)
	return { input, rows: dashboardWindow, tr55: trueRangeSma(dashboardWindow, 55), hash: sha256File(input.file) }
})
...
const result = {
	...
	scope: 'frozen five-minute multi-asset holdout; last 20,000 bars matching Safe dashboard; next-open; no fees, funding or slippage; same management envelope; no 5m refit; Risk replay uses Safe accepted labels and is diagnostic only',
	assumptions: {
...
writeFileSync(resolve(outDir, 'ggi-five-minute-holdout-v1.json'), `${JSON.stringify(result, null, 2)}\n`)
