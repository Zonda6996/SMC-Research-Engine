...
const inputs: InputSpec[] = [
	...
	{ id: 'bnb-3m', file: 'C:/Users/Никита/Downloads/BYBIT_BNBUSDT.P, 3.csv', timeframeMinutes: 3 },
	{ id: 'sp500-1m', file: 'C:/Users/Никита/Downloads/VANTAGE_SP500, 1.csv', timeframeMinutes: 1 },
]
...
const result = {
	...
	scope: 'frozen low-timeframe audit; next-open; no fees, funding or slippage; same envelope as multi-asset holdout; no low-TF refit',
	assumptions: {
...
writeFileSync(resolve(outDir, 'ggi-low-tf-audit-v1.json'), `${JSON.stringify(result, null, 2)}\n`)
